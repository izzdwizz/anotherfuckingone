		...
		<div className={classes.card}>
			<Row>
				<div className={classes.css_rec}>
					...
					<a href='#' target='_blank' class={classes.css_det}>
						{" "}
						Details
					</a>
				</div>
			...
			<Row className={classes.css_tp}>
				<div data-bn-type='text' className={classes.css_18k}>
					Time period
				</div>

				<div className={classes.css_ego2}>
					<div data-bn-type='text' className={classes.css_ego}>
						7D
					</div>
					<div data-bn-type='text' className={classes.css_ego}>
						30D
					...
					<div className={classes.css_formcontainer}>
						...
						<Row className={classes.css_pref}>
							<div className={classes.css_pref}>
								...
								>
									<option value='bnb'>
										<p className='option'>Cross</p>
									</option>
									<option value='btc'>
										<p className='option'>Isolated</p>
									</option>
								</select>
							</div>
							...
							<div>
								...
								>
									<option value='10X'>
										<p className='option'>10X</p>
									</option>
									<option value='20X'>
										<p className='option'>20X</p>
									</option>
									<option value='30X'>
										<p className='option'>30X</p>
									</option>
									<option value='40X'>
										<p className='option'>40X</p>
									</option>
									<option value='50X'>
										<p className='option'>50X</p>
									</option>
								</select>
							</div>
						</Row>
						...
						<Row className={classes.invest_coin}>
							...
							<div className={classes.Invest_area}>
								<img src='https://cryptologos.cc/logos/binance-usd-busd-logo.png?v=023' />{" "}
							</div>
						</Row>
